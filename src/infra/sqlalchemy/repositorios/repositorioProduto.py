...
class RepositorioProduto():
    ...
    def buscarPorId(self,id:int):
        consulta = select(models.Produto).where(models.Produto.usuario_id == id)
        produto  = self.session.execute(consulta).scalars().all()
        return produto


    def editar(self,id:int, produto: schemas.ProdutoEditar):
